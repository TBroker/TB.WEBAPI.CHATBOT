...
namespace TB.Chatbot.Domain.Reponses
{
    public class RespPremium
    {
        ...
        public int cmi_net_premiums { get; set; }
        public int cmi_stamp { get; set; }
        public decimal cmi_tax { get; set; }
        public decimal cmi_total_premiums { get; set; }
        public decimal total_premiums_with_cmi { get; set; }

        [JsonPropertyName("cover_detail")]
        public RespCoverText? respCoverText { get; set; }

        [JsonPropertyName("commission")]
        public RespCalComm? respCalComm { get; set; }
    }
}